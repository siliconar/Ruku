...
for entry in os.listdir(folder_path):
    ...
    for entry2 in os.listdir(folder_sat_fullpath):
        ...
        for entry3 in os.listdir(folder_date_fullpath):
            ...
            basic_product_name = cur_SatID_str +'_AHSI_'+cur_year_str+cur_month_str+cur_day_str+'_'+cur_hour_str+cur_minute_str+cur_second_str+'_'+str(cur_ProductID_int),  # 卫星ID_AHSI_年月日_时分秒_ProductID
